...
const email="asdmdasm@mkasdma",gid="2389910231";
const str= "insert into users(gid,lastOnline,email) values("+"\'"+gid+"\'"+",NOW()"+","+"\'"+email+"\'"+")";
console.log(str);
const re=await db(str);
console.log(re);
...
//     const result =await fetch('https://oauth2.googleapis.com/tokeninfo?id_token='+authToken)
//     .then(res =>{res.json();});
